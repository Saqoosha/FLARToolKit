...
----------------------------------------------------------------------
 * ARToolKit の AS3 版です。
 * Flash player 10 用 (Away3D version4を使用する場合はFlashPlayer 11)
 * nyatla氏の NyARToolkit for AS3 を基盤にFLARToolKit v1.xの
 ...
 * ただし簡単に合成できるようにヘルパー的なものはついてます。
   (Papervision3D, Away3D, Away3D version4)
 ...
 * Add Markersystem.
 * Update the samples at the sketch base.
 * Add Away3D version4 interface.
 * Delete some empty FLARxxx classes.
2.5.5 
