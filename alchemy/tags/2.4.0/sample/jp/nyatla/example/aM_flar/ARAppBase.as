package jp.nyatla.example.aM_flar
{
...
//	import jp.nyatla.nyartoolkit.as3.*;
	...
	{		
		...
		protected var _code:FLxARCode;
		protected var _raster:FLxARRgbRaster;
		protected var _detector:FLxARSingleMarkerDetector;
		...
		protected function init(cameraFile:String, codeFile:String, canvasWidth:int = 320, canvasHeight:int = 240, codeWidth:int = 80):void {
			...
			mf.addTarget(
				this._codeFile,URLLoaderDataFormat.TEXT,
