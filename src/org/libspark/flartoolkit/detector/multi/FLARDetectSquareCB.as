...
package org.libspark.flartoolkit.detector.multi
{
	 ...
	 */
	public class FLARDetectSquareCB implements NyARSquareContourDetector_IDetectMarkerCallback
	{
		//公開プロパティ
		...
		public function FLARDetectSquareCB(i_inst_patt:INyARColorPatt, i_ref_code:Vector.<FLARCode>, i_num_of_code:int, i_param:NyARParam)
		{
