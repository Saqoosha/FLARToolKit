...
package org.libspark.flartoolkit.core
{
	...
	public class FLARParam extends NyARParam
	{
		...
		private static const DefaultCameraParamClass:Class;
		public static function getDefaultParam(width:Number, height:Number):FLARParam {
			var param:FLARParam = new FLARParam();
			param.loadARParamFile(ByteArray(new DefaultCameraParamClass()));
