 ...
 * Contributor(s):
 *  nyatla(nyatla.jp)
 *  F.Rokubou(sixwish.jp)
 * 
 * Commnets
 *  org.libspark.flartoolkit.processor.FLSingleARMarkerManager のコピーです。
 *  元のクラスが flash.display.Sprite を継承していないため使いにくいので、継承するように書き換えただけです。
 *  使い方によってはFLARManger並の機能を持つ……と思われます。
 *  
 */
package examples.manager
{
	...
	public class FLSingleNyIdMarkerManager extends Sprite
	{
		/**
		 * オーナーが自由に使えるタグ変数です。
		 */
		...
		public function FLSingleNyIdMarkerProcesser():void
		{
			return;
		}
