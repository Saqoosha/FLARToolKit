...
package com.libspark.flartoolkit.core {
	...
	public class FLARVec {
	    ...
	    public function FLARVec(i_clm:int) {
	        v = new Array(i_clm);//new double[i_clm];
	        clm = i_clm;
	    }
	    
	    private var v:Array;//double[] v;
	    /**
...
//	        System.out.println(" ===================");//printf(" ===================\n");
	...
	//     * @throws FLARException
	//     */
	//    public static void vecTridiagonalize(NyARMat a, FLARVec d, FLARVec e,int i_e_start) throws FLARException
	//    {
	//	FLARVec vec,vec2;
