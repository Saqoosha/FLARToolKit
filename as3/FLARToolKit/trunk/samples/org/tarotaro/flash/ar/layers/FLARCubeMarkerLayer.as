...
package org.tarotaro.flash.ar.layers 
{
	...
	import org.libspark.flartoolkit.detector.FLARCubeMarkerDetector;
	...
	public class FLARCubeMarkerLayer extends FLARLayer
	{
		...
		{
			super(src, thresh);
			this._detector = new FLARCubeMarkerDetector(param, cube);
		...
		override public function update():void 
		{
			...
			var r:Object = this._detector.detectMarkerLite(this._source, this._thresh);
			if (r != null) {
			//if (numDetected > 0) {
				//trace(numDetected);
